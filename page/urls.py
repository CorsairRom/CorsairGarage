...
from page.views import add_service, delete_detail, detail_service, generate_repair_order, index, list_services, log_out, sign_in, get_client,get_moto,create_client, \
